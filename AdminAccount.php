...
<style type="text/css">.StyleTextField{}
body{
	background-image: url("fel-the-jail-marathipizza.jpg");
...
<div id="Navbar">
	  <nav>
				<ul>
	    			...
	    			<li id="Logo"><a href="AdminAccount.php" title="PRISON MANAGEMENT">PRISON MANAGEMENT</a>		  		</ul>
  </nav>
</div>
<div id="Content">
<div id="contentLeft">
...
<div id="PageHeading"><h2>WELCOME IN
  <?php
